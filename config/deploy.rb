...
set :scm, :git
set :scm_passphrase, ""
set :repository, "https://github.com/rachramadhan/fake-rails1.git"
...
namespace :bundle do
  ...
  task :install do
    run "cd #{current_path} && bundle install  --without=test --path=#{shared_path}/bundle"
  end
end
